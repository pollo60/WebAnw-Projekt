package edu.fra.uas.marcel.controller; // Paketdeklaration: organisiert Klassen im Namensraum und beeinflusst das Classpath-Package
...
public class HelloWorldController { // öffentliche Klasse, die HTTP-Endpunkte (Handler) bereitstellt
